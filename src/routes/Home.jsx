...
const Home = () => {
  return (
    ...
    <h2>Nosso cardápio - Congelados</h2>
     ...
     <div className="dichesContainer">
     <MyDiches image={cabotiacomcostela} title=" 🥩 Escondidinho de Abóbora Cabotiá com Costela 🥩 " ingredients="🌿 A base macia e aveludada da lasanha é cuidadosamente construída com camadas de abóbora cabotiá. A costela, lentamente cozida até a perfeição, desfia-se em pedaços suculentos, oferecendo uma explosão de sabor a cada camada da lasanha 🌿"/>
     <MyDiches image={cremedemilho} title="🌽  Escondidinho de creme de milho com Frango 🌽 " ingredients="🌿 A lasanha é cuidadosamente preparada com camadas de um creme de milho sedoso, que proporciona uma textura suave e um sabor doce e reconfortante. Cada garfada é uma celebração da suavidade do milho. Camadas de frango desfiado, preparado com carinho e temperado para realçar os sabores naturais, oferecem uma textura suculenta e uma experiência leve a cada mordida. 🌿"/>
